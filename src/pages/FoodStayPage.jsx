      ...
      {city && activeTab === "food" && (
        <div>
          ...
          <div className={styles.cardList}>
            {displayFood.map(function(item) {
              const isExpanded = expandedItem === item.id
              return (
                <div key={item.id}>
                  <div className={styles.card} onClick={function() { setExpandedItem(isExpanded ? null : item.id) }}>
                    ...
                    <div className={styles.cardBody}>
                      ...
                      <div className={styles.cardTags}>
                        {item.tags.map(function(t, i) { return <span key={i} className={styles.cardTag}>{t}</span> })}
